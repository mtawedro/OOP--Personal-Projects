...
public class Stock extends Investment{
	...
	* *@return void */ 
	...
	public static void CalculateStockFunds( ArrayList<Investment> investAdd)throws NumberFormatException, IOException{
		...
		BufferedReader myinput = new BufferedReader(new InputStreamReader(System.in));
					...
					if(choice.charAt(0) == 'B' || choice.charAt(0) == 'b' )
					{
						...
						if(exit == true)
						{
							System.out.println("Sorry, there are no Stocks to update shares");
